...
class HourTrackerApp:
    ...
    def create_widgets(self):
        ...
        # Coluna 1, Linha 1: Novo Serviço
        add_service_frame = ttk.Frame(main_frame, padding="50")
        ...
        # Coluna 1, Linha 2: Lançar Horas
        log_hours_frame = ttk.Frame(main_frame, padding="20")
        ...
        # Coluna 1, Linha 3: Resultado Final
        result_frame = ttk.Frame(main_frame, padding="50")
        ...
        # Coluna 2, Linha 1: Visualizar Lançamentos
        view_logs_frame = ttk.Frame(main_frame, padding="5")
        view_logs_frame.grid(row=0, column=1, padx=10, pady=5, sticky='nsew')
        ...
        # Coluna 2, Linha 2: Excluir Lançamento
        delete_log_frame = ttk.Frame(main_frame, padding="50")
        delete_log_frame.grid(row=1, column=1, padx=10, pady=5, sticky='nsew')
        ...
        ttk.Button(delete_log_frame, text="Excluir Lançamento", command=lambda: self.delete_log(log_id_entry.get())).grid(row=2, column=0, columnspan=2, pady=5)
                ...
                # Coluna 2, Linha 3: Pesquisar Lançamentos por Serviço
        search_logs_frame = ttk.Frame(main_frame, padding="5")
        search_logs_frame.grid(row=2, column=1, padx=10, pady=5, sticky='nsew')
        ...
        search_service_combobox.grid(row=1, column=1, pady=5, padx=(0, 5))

        # Aqui definimos search_logs_listbox como um atributo da classe
        self.search_logs_listbox = tk.Listbox(search_logs_frame, selectmode=tk.SINGLE, width=50)
        self.search_logs_listbox.grid(row=2, column=0, columnspan=2, pady=5)

        ttk.Button(search_logs_frame, text="Pesquisar Lançamentos", command=lambda: self.search_logs(search_service_combobox.get())).grid(row=3, column=0, columnspan=2, pady=5)
